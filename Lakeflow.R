...
summary(t)
print(i)
ryan[[i]] = cbind(eqn1(summary(t)$solution[1], summary(t)$solution[3], d_x_area_in, win, sin), data$Q_in,eqn1(summary(t)$solution[2], summary(t)$solution[4], d_x_area_ou, wout, sout), data$Q_out)
}
ryan = as.data.frame(t@population)
ryan = lapply(.pop, as.data.frame)
ryan = rbindlist(ryan)

df = apply(ryan, 2, mean)
NSE(eqn1(df[1], df[3], d_x_area_in, win, sin), data$Q_in)
NSE(eqn1(df[2], df[4], d_x_area_ou, wout, sout), data$Q_out)

plot(data$Q_in, type = "l")
points(eqn1(df[1], df[3], d_x_area_in, win, sin), pch = 19, col = "blue")
plot(data$Q_out, type = "l")
points(eqn1(df[2], df[4], d_x_area_ou, wout, sout), pch = 19, col = "blue")
plot(t)
plot(data$Q_out, eqn1(df[2], df[4], d_x_area_ou, wout, sout), xlim = c(100,600), ylim = c(100,600))
abline(0,1)
plot(data$Q_in, eqn1(df[1], df[3], d_x_area_in, win, sin), xlim = c(100,600), ylim = c(100,600))
abline(0,1)

plot(data$dV, type = "l")
points(eqn1(summary(t)$solution[1], summary(t)$solution[3], d_x_area_in, win, sin)-eqn1(summary(t)$solution[2], summary(t)$solution[4], d_x_area_ou, wout, sout)-data$ET+data$sum, col = "blue", pch = 19)
abline(0,1)
...
plot(abs(uncOu), abs(error), xlim = c(0,300),  ylim = c(0,300))
